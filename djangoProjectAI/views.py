...
imageClassList = {'0': 'Лев', '1': 'Слон', '2': 'Черепаха'}  #Сюда указать классы
...
def predictImageData(modelName, filePath):
    ...
    sess = onnxruntime.InferenceSession('./media/models/cifar100.onnx') #<-Здесь требуется указать свой путь к модели
